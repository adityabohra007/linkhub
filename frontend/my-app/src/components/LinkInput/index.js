        ...
        <div className="rightSection">
          <div>
            ...
            <div className="functionalityWrapper" style={{ paddingTop: 10 }}>
              {/* <div> */}
              <FaDirections
                className={`function Redirect  ${
                  initialData.methods?.Redirect && "active"
                } `}
                onClick={() => {
              ...
              <BsImage
                className={`function Thumbnail  ${
                  initialData.methods?.Thumbnail && "active"
                } `}
                onClick={() => {
              ...
              ></BsImage>
              <AiOutlineStar
                className={`function Prioritize  ${
                  initialData.methods?.Prioritize && "active"
                } `}
                onClick={() => {
              ...
              ></AiOutlineStar>
              <AiOutlineCalendar
                className={`function Schedule  ${
                  initialData.methods?.Schedule && "active"
                } `}
                onClick={() => {
              ...
              ></AiOutlineCalendar>
              <BiLock
                className={`function Lock  ${
                  initialData.methods?.Lock && "active"
                } `}
                onClick={() => {
